...
# Load model dan encoder dari file lokal
best_model = joblib.load('best_model.pkl')
booking_status_encode = joblib.load('booking_status_encode.pkl')  # Ini dict
label_encoder = joblib.load('label_encoder.pkl')  # Optional, kalau nggak dipakai bisa dihapus

# Cek apakah semuanya berhasil dimuat
if best_model and booking_status_encode and label_encoder:
    st.success("✅ Model dan encoder berhasil dimuat!")

    # Data input user (yang udah lengkap dari kamu)
    user_input = {
        'no_of_adults': [2],
        'no_of_children': [1],
    ...
    st.warning("❗ Gagal memuat model atau encoder. Pastikan file pickle tersedia.")